...
Begin VB.Form frmMain 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.ListBox lvTasks 
         Height          =   4050
         ItemData        =   "frmMain.frx":43BC
         Left            =   -74880
         List            =   "frmMain.frx":43C3
         Style           =   1  '확인란
         TabIndex        =   25
         Top             =   120
         Width           =   2295
      ...
      Begin VB.ListBox lvContacts 
         Height          =   4020
         ItemData        =   "frmMain.frx":43D8
         Left            =   -74880
         List            =   "frmMain.frx":43DF
         TabIndex        =   3
         Top             =   120
         Width           =   1695
      End

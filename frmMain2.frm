...
Begin VB.Form frmMain 
   ...
   Begin TabDlg.SSTab ssTodaysPlan 
      ...
      Tab(0).Control(0)=   "lvTodaysPlans"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "lvTodaysPlan"
   ...
   Begin TabDlg.SSTab ssRibbonMenu 
      ...
      EndProperty
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "frmMain2.frx":5C16A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "home"
      TabPicture(1)   =   "frmMain2.frx":5C186
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      ShowFocusRect   =   0   'False
      BackColor       =   -2147483636
      MouseIcon       =   "frmMain2.frx":5E6E0
      TabCaption(0)   =   "일정"
      TabPicture(0)   =   "frmMain2.frx":5E6FC
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Dir1"
      Tab(0).Control(1)=   "MonthView1"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "주소록"
      TabPicture(1)   =   "frmMain2.frx":5EB4E
      Tab(1).ControlEnabled=   0   'False
      ...
      TabCaption(2)   =   "할 일"
      TabPicture(2)   =   "frmMain2.frx":5EFA0
      Tab(2).ControlEnabled=   0   'False
      ...
      TabCaption(3)   =   "일과표"
      TabPicture(3)   =   "frmMain2.frx":5F3F2
      Tab(3).ControlEnabled=   0   'False
      ...
      TabCaption(4)   =   "알람"
      TabPicture(4)   =   "frmMain2.frx":5F70C
      ...
      TabCaption(5)   =   " 메모"
      TabPicture(5)   =   "frmMain2.frx":5FB5E
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "Text1"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "그림판"
      TabPicture(6)   =   "frmMain2.frx":5FFB0
      Tab(6).ControlEnabled=   0   'False
      Tab(6).ControlCount=   0
      TabCaption(7)   =   "계산기"
      TabPicture(7)   =   "frmMain2.frx":60402
      ...
      TabCaption(8)   =   "타이머"
      TabPicture(8)   =   "frmMain2.frx":60854
      ...
      Begin TabDlg.SSTab ssTimerType 
         ...
         ShowFocusRect   =   0   'False
         TabCaption(0)   =   "타이머"
         TabPicture(0)   =   "frmMain2.frx":60CA6
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).ControlCount=   0
         TabCaption(1)   =   "스톱워치"
         TabPicture(1)   =   "frmMain2.frx":60CC2
         Tab(1).ControlEnabled=   0   'False
      ...
      Begin VB.ListBox lvContacts 
         Height          =   4020
         ItemData        =   "frmMain2.frx":60CDE
         Left            =   -74880
         List            =   "frmMain2.frx":60CE5
         TabIndex        =   156
         Top             =   76
         Width           =   1695
      End
      ...
      Begin VB.ListBox lvTasks 
         Height          =   4050
         ItemData        =   "frmMain2.frx":60CFC
         Left            =   -74880
         List            =   "frmMain2.frx":60D03
         Style           =   1  '확인란
         TabIndex        =   123
         Top             =   76
         Width           =   2295
...
Private Sub cmdHelp_Click()
    If GetSetting("Calendar", "Options", "TP", 0) = 0 Then
        PopupMenu frmMainOld.mnuHelp, , Me.Width - 2350 - ssTodaysPlan.Width + 100, 400
    Else
...
Private Sub hideshow_Timer()
    ...
    If pos.y * 15 > Me.Top - 500 And pos.y * 15 < Me.Top + ssRibbonMenu.Height And pos.x * 15 > Me.Left And pos.x * 15 < Me.Left + ssRibbonMenu.Width Then
        showrm
    Else
        hiderm
    End If
